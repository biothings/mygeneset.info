...
class TestUserGenesets(MyGenesetLocalTestBase):
    ...
    def test_create_geneset_dry_run(self):
        payload = json.dumps({"name": "Test geneset", "is_public": True, "genes": ["1001"]})
        headers = {
        ...
        for key, val in doc.items():
            ...
            assert (
                val == expected_response["new_document"][key]
            ), f"{key} does not match the expected value"
    ...
    def test_create_public_geneset(self):
        ...
        headers = {"Cookie": "user=%s" % open("user_cookie.txt").read()}
        res = self.request(
            f"{self.HOST}/v1/user_geneset", method="POST", headers=headers, data=payload
        )
        results = res.json()
        ...
        res = self.request(f'{self.HOST}/v1/geneset/{results["_id"]}', method="GET")
    ...
    def test_create_private_geneset(self):
        ...
        res = self.request(f'{self.HOST}/v1/geneset/{results["_id"]}', method="GET", expect=404)
        # Passing the cookie should return the geneset
        res = self.request(
            f'{self.HOST}/v1/geneset/{results["_id"]}', method="GET", headers=headers
        )
    ...
    def test_delete_public_geneset(self):
        ...
        # Create a geneset
        payload = json.dumps(
            {"name": "Test geneset to delete", "genes": ["1001"], "is_public": "true"}
        )
        res = self.request(
            f"{self.HOST}/v1/user_geneset", method="POST", headers=headers, data=payload
        )
        ...
        res = self.request(f"{self.HOST}/v1/user_geneset/{_id}", method="DELETE", expect=401)
        # Delete the geneset
        res = self.request(f"{self.HOST}/v1/user_geneset/{_id}", method="DELETE", headers=headers)
        ...
        res = self.request(f"{self.HOST}/v1/geneset/{_id}", method="GET", expect=404)

    def test_delete_private_geneset(self):
        headers = {"Cookie": "user=%s" % open("user_cookie.txt").read()}
        # Create a geneset
        payload = json.dumps(
            {"name": "Test private geneset to delete", "genes": ["1001"], "is_public": "false"}
        )
        res = self.request(
            f"{self.HOST}/v1/user_geneset", method="POST", headers=headers, data=payload
        )
        ...
        # Query to make sure it's gone
        res = self.request(
            f"{self.HOST}/v1/geneset/{_id}", headers=headers, method="GET", expect=404
        )
    ...
    def test_update_geneset_add(self):
        ...
        # Create a geneset
        payload = json.dumps(
            {"name": "Test geneset to update", "genes": ["1001"], "is_public": "true"}
        )
        res = self.request(
            f"{self.HOST}/v1/user_geneset", method="POST", headers=headers, data=payload
        )
        ...
        time.sleep(2)
        # Without the cookie, expect 401
        res = self.request(f"{self.HOST}/v1/user_geneset/{_id}", method="PUT", expect=401)
        # Update the geneset
        payload = json.dumps(
            {
        ...
        res = self.request(f"{self.HOST}/v1/geneset/{_id}", method="GET")
        assert res.json()["name"] == "Test geneset to update"
    ...
    def test_update_geneset_remove(self):
        ...
        # Create a geneset
        payload = json.dumps(
            {"name": "Test geneset to update", "genes": ["1001", "1002"], "is_public": "true"}
        )
        res = self.request(
            f"{self.HOST}/v1/user_geneset", method="POST", headers=headers, data=payload
        )
    ...
    def test_update_geneset_replace(self):
        ...
        res = self.request(f"{self.HOST}/v1/geneset/{_id}", method="GET", expect=404)
        # Query to make sure it's updated
        res = self.request(f"{self.HOST}/v1/geneset/{_id}", method="GET", headers=headers)
        assert res.json()["name"] == "Test geneset to update"
    ...
    def test_create_geneset_empty(self):
        ...
        # Create a geneset
        payload = json.dumps({"name": "Test empty geneset", "genes": [], "is_public": "true"})
        res = self.request(
            f"{self.HOST}/v1/user_geneset", method="POST", headers=headers, data=payload
        )
        results = res.json()
    ...
    def test_create_geneset_invalid(self):
        ...
        # Create a geneset
        payload = json.dumps(
            {"name": "Test geneset with invalid gene", "genes": "none", "is_public": True}
        )
        res = self.request(
    ...
    def test_create_geneset_invalid2(self):
        ...
        # Create a geneset
        payload = json.dumps({"name": "Test geneset without genes", "is_public": "true"})
        res = self.request(
            f"{self.HOST}/v1/user_geneset",
            method="POST",
            headers=headers,
    ...
    def test_create_geneset_invalid3(self):
        ...
        # Create a geneset
        payload = json.dumps({"genes": ["1001", "1002"], "is_public": "true"})
        res = self.request(
            f"{self.HOST}/v1/user_geneset",
            method="POST",
            headers=headers,
    ...
    def test_update_multispecies_geneset_add(self):
        ...
        payload = json.dumps({"genes": ["1001", "507781"]})
        res = self.request(
            f"{self.HOST}/v1/user_geneset/{_id}?gene_operation=add",
            method="PUT",
            headers=headers,
    ...
    def test_update_multispecies_geneset_remove(self):
        ...
        time.sleep(2)
        # Remove two genes
        payload = json.dumps({"genes": ["98660", "507781"]})
        res = self.request(
            f"{self.HOST}/v1/user_geneset/{_id}?gene_operation=remove",
            method="PUT",
            headers=headers,
