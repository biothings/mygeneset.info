def get_customized_mapping(cls):
    mapping = {
        ...
        "metabolites": {
            "properties": {
                "mychem_id": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "smpdb_metabolite": {
                    "normalizer": "keyword_lowercase_normalizer",
                    "type": "keyword",
                },
                "hmdb": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "kegg_cid": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "chebi": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "drugbank": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                ...
                "chembl": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "cas": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
                "name": {"type": "text"},
                "iupac": {"normalizer": "keyword_lowercase_normalizer", "type": "keyword"},
            }
        },
